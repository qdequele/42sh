...
# define SHIFT_UP ((buf[0] == 27 && buf[1] == 27 && buf[2] == 91 &&\
buf[3] == 65))
# define SHIFT_MAJ_UP ((buf[0] == 27 && buf[1] == 91 && buf[2] == 49 &&\
buf[3] == 59 && buf[4] == 49 && buf[5] == 48 && buf[7] == 65))
# define DOWN ((buf[0] == 27 && buf[1] == 91 && buf[2] == 66))
# define SHIFT_DOWN ((buf[0] == 27 && buf[1] == 27 && buf[2] == 91 &&\
buf[3] == 66))
# define SHIFT_MAJ_DOWN ((buf[0] == 27 && buf[1] == 91 && buf[2] == 49 &&\
buf[3] == 59 && buf[4] == 49 && buf[5] == 48 && buf[7] == 66))
...
# define ALT_X (buf[0] == -30 && buf[1] == -119 && buf[2] == -120 &&\
buf[3] == 0)
# define ALT_B (buf[0] == -30 && buf[1] == -120 && buf[2] == -85 &&\
buf[3] == 0)
